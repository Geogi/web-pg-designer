...
export const settingsDatabase = createAction("SETTINGS/DATABASE", (s: string) => s);
export const settingsUser = createAction("SETTINGS/USER", (s: string) => s);
export const settingsPassword = createAction("SETTINGS/PASSWORD", (s: string) => s);
...
export const relationsCreateShow = createAction("RELATIONS/CREATE/SHOW", (b: boolean) => b);
export const relationsCreateName = createAction("RELATIONS/CREATE/NAME", (s: string) => s);
export const relationsCreateErr = createAction("RELATIONS/CREATE/ERR", (s: string) => s);
